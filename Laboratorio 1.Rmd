...
estudiantes_tipoA <- subset(info_estudiantes, tipo == "A")
n_estudiantes_tipoA_notaAlta <- sum(estudiantes_tipoA$promedio > 85)
probabilidad_tipoA_notaAlta <- n_estudiantes_tipoA_notaAlta / nrow(estudiantes_tipoA)
